  ...
  <body>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light sidebar" style="width: 300px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>Admin/Dashboard" class="nav-link link-dark" aria-current="page">
          ...
          <li>
            <a href="<?php echo base_url(); ?>Admin/Profile" class="nav-link link-dark active" aria-current="page">
