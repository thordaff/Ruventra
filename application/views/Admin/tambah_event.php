  ...
  <body>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light sidebar" style="width: 300px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>Admin/Dashboard" class="nav-link link-dark">
              <i class="fa-solid fa-gauge icon"></i>
              Dashboard
            </a>
          </li>
          <li>
            <a href="<?php echo base_url(); ?>Admin/TambahEvent" class="nav-link link-dark active" aria-current="page">
